...
1.1 
EC2 (Elastic Compute Cloud) - a web service that provides secure and resizable virtual servers on the cloud.
...
  - Optimal for transactional data (OLTP) and Online Analytical Processing (OLAP)
  - ACID properties - Atomicity, consistency, Isolation, durability
  - Vertical scaling
  - Fixed, Row and column-based schema
- NoSQL (NonRelational Databases)
  - Can be any type, as key-value, graph, document, semi-structured data, etc
  - High throughput and low latency
  - Horizontal Scaling, partitionable and distributed architecture
  - Can provide ACID by using DynamoDB
